...
// Structured so seed-enemies.js can gate damage the way it gates HP.
// ⚠️ Floor '' (null) = unset. Floor 0 is the TUTORIAL, a real gated floor (2026-09-15).
function BLANK_SIG() { return { floor: null, damage: 0, type: '', exception: '', note: '' }; }
...
const FLOOR_DAMAGE = {
  0: { mob: 3,  elite: 4,  boss: 6,  legendary: 9 },   // tutorial — torso 5, level 6
...
function SignatureRow({ value, onChange }) {
  ...
  const hasFloor = sig.floor !== null && sig.floor !== undefined && sig.floor !== '';
  const band = hasFloor ? (FLOOR_DAMAGE[sig.floor] || {})[value.tier || 'mob'] : null;
  ...
  return (
    <div style={{ marginBottom: 8 }}>
      ...
      <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'center' }}>
        <select className="fi" style={{ width: 96 }} value={hasFloor ? String(sig.floor) : ''}
                onChange={e => set({ floor: e.target.value === '' ? null : Number(e.target.value) })}>
          <option value="">Floor —</option>
          <option value="0">F0 tutorial</option>
