...
### 🔒 The destination — RULED 2026-08-25

The owner is right that *"where it heard of the mask"* answers why the Loong is **travelling**,
not why the journey **ends**. A lead is a waypoint. Here is the destination.

#### The village is the SURVIVORS of the F1 city

> **Owner:** *"a few adults and children managed to run away in time, and they established some
> foundation of people."*

A handful got out before the mist. Seventy years on they are a small desert settlement — two or
three generations deep, founded by refugees, and **they do not know what they are descended
from.** The Loong does not know they exist.

⭐ **This is what "finds purpose" was reaching for, made literal.** A guardian with nothing left
to guard is handed its post back in miniature. And it does not contradict Floor 1 — 🔒 **the
party's F1 argument was *"staying here will lead to nothing."*** That was **true**. There *was*
nothing left in the city for it. **What it should have been guarding had already walked out**,
and arriving here is the party being proved right in the one way that hurts.

#### 🎭 The village remembers it as a god

> **Owner:** *"some story about a guardian deity that protected them in the form of a long snake
> or a tall woman."*

🔒 **Both forms survive in the folklore** — the long snake and the tall woman — which is the
hint, and the party will place it before the Loong does. The villagers do not think the story is
real. It is a harvest tale and a thing you tell children.

⭐ **And it is quietly exact under S-0's clarification:** *a god in v1 is just a worshipped
entity.* The Loong has had worshippers for seventy years and never knew. **It is a god by the
only definition this edition uses**, and it finds that out by walking into a village.

⚠️ **The villagers must never work it out.** They are farmers with an old song; the party and the
Loong put it together and nobody tells them. A village that knows it is standing in front of its
own deity turns the scene sentimental. **Keep it on the party's side of the table.**

#### 🧭 The travelling trader carries the mask news

🔒 **The mask lead comes from a trader, not from the village.** A travelling merchant working the
desert circuit carries word of a masked man — that is **how the Loong heard**, and the trader is
mobile, so the party can meet them on the road, at the village, or both.

⚙️ **Splitting the two sources is what makes the floor land.** The village gives it **something
to protect**; the trader gives it **somewhere to go.** Arriving is not the end of the errand —
it is the moment the errand acquires a reason beyond grief.

#### What this resolves

| Problem | Resolved |
|---|---|
| *"Finds purpose" was vague* | Literal: a post handed back |
| *Why the journey ends here* | It is the thing it lost, reached by accident |
| *Why it still goes to the capital at F3* | 🔴 **Stronger** — it has something to lose again, and the mask is what took it the first time |
| *`Shepherd`* | You led it home, to a home it did not know it had |
| *`Livestock`* | 🔴 **Darker** — you sold it at the moment it found its people |
| *The shed scale* | A gift to the descendants of the people it failed. **That** is why the world's only M-5 Loong-Scale comes from this room |
