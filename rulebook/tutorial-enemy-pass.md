...
| ~~5~~ | ✅ **RULED 2026-09-22 — the party gets the brothers' loot, plus THREE STORE COUPONS EACH**, spent on whatever they like in the §19.3 store. ⭐ **Three coupons is a better instrument than a discount:** §19.3 already prices everything at 1–3 UT, so three coupons buys **three of anything** — which means the decision is *what*, never *whether*, and a contestant who wants one Basic thing (3 UT) is trading three Crude things for it. ⚙️ It also lands where it should: **the store closes at the Lounge unlock and the Incinedile is that unlock**, so this is the last shopping trip and it is deliberately generous. ⚠️ The coupons take the dearest line off the bill (§19.3), so **buy the expensive thing with a coupon, not the cheap one.** ~~Owner considered giving the brothers' weapons free plus an extra shop coupon on a peaceful resolution; the coupon is unpriced.~~ |
