...
module.exports = [
  ...
  BOSS('The Doorward', {
    ...
    notes: [
      ...
      '',
      'BUT THE FEEDING IS WHAT HAS BEEN HOLDING THE TRANSFORMATION BACK. The mask remakes',
      'a host into something a demon can wear, and it leaks plague while it works. With',
      'the leak drained off every day, the work never finishes.',
      '',
      'KILL IT AND THE MASK FINISHES. The transformation completes, and what the chains',
      'were built to hold is no longer what is in them. He walks out on his own, some',
      'years later, and reaches the capital as Nullrot (§4.2).',
      'The party freed him. They were right to. Do not warn them.',
      '',
  ...
  BOSS("The Hunt's Owner", {
    ...
    notes: [
      ...
      '',
      'IT IS NOT WANDERING. Seventy years crossing this desert looking for the SOURCE of',
      'what took its city — it does not know a cure and does not claim to, only that a',
      'sickness has a beginning. Somewhere out here IT HEARD OF THE MASK, and it believes',
      'finding the mask is the road to healing its people. It is right, and not in the way',
      'it hopes.',
