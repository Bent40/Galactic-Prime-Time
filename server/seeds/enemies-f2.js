...
module.exports = [
  ...
  BOSS('The Doorward', {
    ...
    notes: [
      ...
      '',
      'IT SPEAKS BEFORE IT FIGHTS (ruled 2026-08-24). It warns them, out loud, truthfully:',
      '"Beware, fools who seek this grave... My hunger is sated here, feasting on this man.',
      'Do not make me turn it to you." Glowing dust and cursed-gold signs draw treasure',
      'hunters to the doorway. IT STATES THE MECHANISM AND THEY WILL HEAR MENACE — which is',
      'the point: the clue exists, at the moment of the choice, and is insufficient anyway.',
      'NOT AN ILLUSION. Say "deception," never "illusion" — in a system where actions',
      'auto-succeed on requirements, an illusion is a capability claim that owes the players',
      'a resistance mechanic. Nothing here is a false face. THE TRUEST VOICE IN THE ROOM IS',
      'THE LURE: the chained man is a genuinely real, suffering, honest old man who wants',
      'out, every word he says is true, and freeing him is exactly what the thing inside',
      'needs. The trap is that suffering is pitiable. (The Doorward slightly misreads it too,',
      'crediting cunning where there is only situation.)',
      '',
      ...
      '',
      'BUT THE FEEDING IS WHAT HAS BEEN HOLDING THE CONVERSION BACK. The mask is NULLROT\'S',
      'OWN RELIQUARY — blessed by the buried god CINNABRUS so his champion could be worn',
      'back if he was ever killed, and SEALED by BEELZEBUB when he put the god down.',
      'Nullrot is forcing that seal from the inside; forcing it is what takes the host',
      'apart, and it leaks plague the whole time it works. With the leak drained off daily,',
      'the work never finishes.',
      '',
      'KILL IT AND THE SEAL GIVES. The conversion completes, and what the chains were',
      'built to hold is no longer what is in them. NULLROT WALKS OUT ON HIS OWN — with the',
      'man still inside him — and reaches the capital a hundred years later (§4.2).',
      '',
      'AND KILLING IT IS THE RIGHT MOVE (ruled 2026-08-24). This is a TRIGGER, NOT A TRAP.',
      'The best ending needs Nullrot and the Loong in the same room; Nullrot chained forever',
      'is stasis and no cure ever exists. The party is correct in their own terms AND in the',
      'campaign\'s. NEVER PLAY THIS AS A MISTAKE THEY SHOULD HAVE AVOIDED. The only thing',
      'missing is RECOGNITION, and F3 supplies it: the host says "he told us," and he did.',
      '',
  ...
  BOSS('Bex, the Rival Noble', {
    ...
    notes: [
      ...
      '',
      'HIS CLAN IS NOT HERS. Killing his body did not take because his clan lives on',
      'elsewhere (clan law, ruled 2026-08-24) — a demon dies only when its clan dies, and',
      'rebirth runs through clan bloodline, which costs decades. The +100 years to F3 pays',
      'for it. Vermilia is killable for the opposite reason: she is the last of hers.',
      '',
      'HE IS NOT A SELF-INTERESTED SCHEMER (ruled 2026-08-20). Bex does what he believes is',
      'necessary FOR DEMONKIND — the hunger lifted, the leash off Beelzebub, no more eating',
      'people to stay alive. He wants the throne because the throne can deliver that. His',
      'means are ugly, he knows it, and he does not defend them. Play the conviction, not',
      'the ambition; the party should leave this room unsure they killed the right one.',
      '',
