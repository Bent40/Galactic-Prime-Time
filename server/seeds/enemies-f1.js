...
module.exports = [
  ...
  MOB('Crystal Spore Mist', {
    ...
    notes: [
      ...
      '  AT INFECTED T3, instead of the 2-Clock death timer: CRYSTALLIZATION COMPLETES.',
      '    The contestant is a statue. NOT DEAD — and not recoverable until the F3 cure',
      '    exists. See E-0.6; that severity needs an owner ruling before it is seeded.',
      '',
