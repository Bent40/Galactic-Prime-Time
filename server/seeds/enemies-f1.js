...
module.exports = [
  ...
  BOSS('Foreman Bex', {
    ...
    notes: [
      ...
      'Bex is the rival demon. He is burning this house to kill the Girl — a rival — by',
      'proxy, using humans, because using humans is the only way he knows how to be near',
      'them. Everything about him reads as a reasonable person because he has had a very',
      'long time to practise.',
      '',
