...
module.exports = [
  ...
  MOB('Roach-dog', {
    ...
    notes: [
      ...
      '',
      'HP NOTE — the live sim roster has this at 1 HP (carapace). Doctrine at floor 0',
      'is 2, and 2 is what is written here. ⚖ RECOMMENDED, NOT RULED: the change is',
      'invisible at the table, because a tutorial contestant swings for 2 and kills it',
      'in one either way. All it stops is a BARE FIST one-shotting a roach.',
    ].join('\n'),
  }),
